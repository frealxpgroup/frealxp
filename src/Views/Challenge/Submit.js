...
class Submit extends Component {
  ...
  getChallengesButton = () => {
    ...
    axios.post(`/challenge/tracked/one`, { user_id }).then(res => {
      this.setState({
  ...
  render() {
    console.log(
      "this is the user's tracked challenges: ",
    ...
    return (
      <div className="submit-main">
        ...
        <p className="date-title">
          Selected Challenge: {this.state.selectedChallenge}
        </p>
        <div>
          <div className="select-challenge">
            <button
              className="challenge-button"
              onClick={this.getChallengesButton}
            >
